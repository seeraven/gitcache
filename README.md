...
location of your choice, for example `~/bin`:
    ...
    wget https://github.com/seeraven/gitcache/releases/download/v1.0.11/gitcache_v1.0.11_Ubuntu22.04_amd64
    mv gitcache_v1.0.11_Ubuntu22.04_amd64 ~/bin/gitcache
