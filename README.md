...
location of your choice, for example `~/bin`:
    ...
    wget https://github.com/seeraven/gitcache/releases/download/v1.0.31/gitcache_v1.0.31_Ubuntu22.04_x86_64
    mv gitcache_v1.0.31_Ubuntu22.04_x86_64 ~/bin/gitcache
...
extract it at your desired target location (the archive contains a subfolder):
    ...
    tar xfz gitcache_v1.0.31_Darwin_arm64.tgz
    xattr -cr gitcache_v1.0.31_Darwin_arm64
    ls gitcache_v1.0.31_Darwin_arm64
...
https://github.com/seeraven/gitcache/releases and is installed using pip:
    ...
    pip install gitcache-1.0.29-py3-none-any.whl
