...
location of your choice, for example `~/bin`:
    ...
    wget https://github.com/seeraven/gitcache/releases/download/v1.0.27/gitcache_v1.0.27_Ubuntu22.04_x86_64
    mv gitcache_v1.0.27_Ubuntu22.04_x86_64 ~/bin/gitcache
...
extract it at your desired target location (the archive contains a subfolder):
    ...
    tar xfz gitcache_v1.0.27_Darwin_arm64.tgz
    xattr -cr gitcache_v1.0.27_Darwin_arm64
    ls gitcache_v1.0.27_Darwin_arm64
...
https://github.com/seeraven/gitcache/releases and is installed using pip:
    ...
    pip install gitcache-1.0.27-py3-none-any.whl
...
is pushed to the repository. This changes the release process a little bit:
  ...
  - Now prepare the next version. Edit the files `Makefile`, `pyproject.toml`,
    ...
    replace the version number:
        ...
        sed -i 's/1.0.27/1.0.28/g' Makefile pyproject.toml src/git_cache/git_cache_command.py doc/source/installation.rst
