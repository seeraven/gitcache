...
itself, so the integration in other scripts won't be possible::
    ...
    $ wget https://github.com/seeraven/gitcache/releases/download/v1.0.11/gitcache_v1.0.11_Ubuntu18.04_amd64
    $ mv gitcache_v1.0.11_Ubuntu18.04_amd64 /usr/local/bin/gitcache
