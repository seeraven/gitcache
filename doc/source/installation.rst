...
:code:`/usr/local/bin`.
    ...
    $ wget https://github.com/seeraven/gitcache/releases/download/v1.0.34/gitcache_v1.0.34_Ubuntu22.04_amd64
    $ mv gitcache_v1.0.34_Ubuntu22.04_amd64 /usr/local/bin/gitcache
